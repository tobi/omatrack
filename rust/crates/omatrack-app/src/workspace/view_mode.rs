...
impl Workspace {
    ...
    pub(super) fn set_view_mode(&mut self, mode: TraceViewMode, cx: &mut Context<'_, Self>) {
    ...
    fn enter_corners_view(&mut self, cx: &mut Context<'_, Self>) {
    ...
    /// else the first.
    fn frame_start_corner(&mut self, id: Option<String>, cx: &mut Context<'_, Self>) {
    ...
    fn leave_corners_view(&mut self, cx: &mut Context<'_, Self>) {
    ...
    pub(super) fn refit_view_mode(&mut self, previous: Option<String>, cx: &mut Context<'_, Self>) {
    ...
    pub(super) fn escape_view_mode(&mut self, cx: &mut Context<'_, Self>) -> bool {
        if self.view_mode(cx) != TraceViewMode::Corners {
            return false;
        }
    ...
    pub(super) fn toggle_trace_color_mode(&mut self, cx: &mut Context<'_, Self>) {
