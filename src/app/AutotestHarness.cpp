                        ...
                        if (best >= 0) {
                                        ...
                                        for (const QVariant& otherSessionValue :
                                            ...
                                            for (const QVariant& otherLapValue :
                                                ...
                                                const QVariantMap otherLap =
                                                    otherLapValue.toMap();
                                                if (!otherLap.value("isFastest")
                                                         .toBool())
                                                    continue;
                                                // First selected session is the
                                                // fixed reference; second is
                                                // the active run.
                                                store.selectLap(
                                                    otherKey,
                            ...
                            if (autotestZoom &&
                                ...
                                if (trace && trace->width() > 0 &&
                                    ...
                                    qWarning()
                                        << "AUTOTEST zoom paint average_ms:"
                                        << (clock.nsecsElapsed() / 1.0e6) /
                                               frames;
                                ...
                                [&store, &engine, shotPath, startupVideoPath,
                                 ...
                                 autotestBrakeSync, autotestCornerEdit]() {
                                    ...
                                    if (!videoReady) {
                                        ...
                                        if (!videoReady)
                                            qWarning()
                                                << "AUTOTEST video failed to "
                                                   "load or sync";
                                    }
                                    if (windows.isEmpty())
                                        qWarning()
                                            << "AUTOTEST found no QQuickWindow";
                                    ...
                                    if (autotestRename) {
                                        ...
                                        renameReady =
                                            ...
                                            store.driverDisplayName(
                                                ...
                                                QStringLiteral(
                                                    "Autotest Driver");
                                        qWarning() << "AUTOTEST driver rename:"
                                                   << renameReady;
                                    }
                                    ...
                                    for (QQuickWindow* window : windows) {
                                        ...
                                        if (image.save(output))
                                            qWarning()
                                                << "AUTOTEST saved:" << output
                                                << image.size();
                                        else
                                            qWarning()
                                                << "AUTOTEST save failed:"
                                                << output;
                                    }
